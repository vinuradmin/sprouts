#!/usr/bin/env python3
"""
Complete restaurant analysis - add missing restaurants and rerun comparison
"""
...
def add_missing_restaurants():
    """Add missing restaurants from Chef Availabilities to database"""
    print("="*80)
    print("ADDING MISSING RESTAURANTS FROM CHEF AVAILABILITIES")
    print("="*80)
    ...
    try:
        ...
        # Extract restaurant names from Chef Availabilities
        ...
        restaurants_to_add = chef_restaurants - db_restaurant_names
        ...
        if restaurants_to_add:
            ...
            for restaurant_name in restaurants_to_add:
                details = chef_details.get(restaurant_name, {})
                ...
                new_restaurant = Restaurant(
                    ...
                    restaurant_location=details.get('location', "San Francisco"),
...
def rerun_complete_analysis():
    ...
    try:
        ...
        # Create final report
        report_data = [
            ['Complete Analysis with All Restaurants (Updated)'],
            [''],
            ['MATCHING STATISTICS'],
...
def main():
    ...
    added_count = add_missing_restaurants()
    print(f"\nAdded {added_count} restaurants to database")
    
    # Step 2: Rerun complete analysis
    complete, partial = rerun_complete_analysis()
    
    print(f"\n" + "="*80)
    print("FINAL COMPLETE ANALYSIS WITH ALL RESTAURANTS - DONE")
    print("="*80)
